  ...
  ## Description
  A command line application that takes in a few user inputs and generates a professional README file
  ...
  ## Installation
  Node.js and inquirer(v8.2.4) must be installed
  ...
  ## Contributing
  To contribute, please contact user in Questions section
  ...
  ## Tests
  Tested using inputs to create a professional README
